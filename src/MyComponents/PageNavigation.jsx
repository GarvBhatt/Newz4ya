...
const PageNavigation = (props) =>{
    return(
        ...
        <Button disabled={props.pageNo==1} className="btn-lg my-4" variant="dark" type="button" style={{margin:"8px !important"}} onClick={()=>{props.setpageNo(props.pageNo-1);props.setisItTrueLeonard(true)}}>Prev</Button>
        ...
        <Button disabled={props.pageNo==12} className="btn-lg my-4" variant="dark" type="button" onClick={()=>{props.setpageNo(props.pageNo+1);props.setisItTrueLeonard(true)}}>Next</Button>
      </div>
    )
}
